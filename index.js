...
app.get('/top_artists', (req, res) => {
  let sql = "SELECT * FROM artists ORDER BY name LIMIT 20";
  con.query(sql, function (err, result) {
    if (err) throw err;
    res.send(result)
    })
...
app.get('/top_albums', (req, res) => {
  let sql = "SELECT * FROM albums ORDER BY name LIMIT 20";
  con.query(sql, function (err, result) {
    if (err) throw err;
    res.send(result)
    })
...
app.get('/top_playlists', (req, res) => {
  let sql = "SELECT * FROM playlist ORDER BY name LIMIT 20";
  con.query(sql, function (err, result) {
    if (err) throw err;
    res.send(result)
    })
